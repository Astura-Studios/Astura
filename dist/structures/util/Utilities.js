...
class Utilities {
    ...
    ;
    runVerification(member, memberRole) {
        return __awaiter(this, void 0, void 0, function* () {
            const captcha = new Captcha_1.Captcha();
            yield member.createDM()
                .then((dm) => __awaiter(this, void 0, void 0, function* () {
                dm.send({
                    embeds: [
                        {
                ...
                const collector = dm.createMessageCollector({ filter });
                const retryCollector = dm.createMessageCollector({ filter });
                ...
                retryCollector.on("collect", (message) => {
