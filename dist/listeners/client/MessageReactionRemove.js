...
class MessageReactionRemoveListener extends Listener_1.Listener {
    constructor() {
    ...
    exec(reaction, user) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return console.log(`${this.client.util.date.getLocalTime()} | [ Message Reaction Remove Listener ] ${error.stack}`);
            }
            ;
        });
    }
...
exports.default = MessageReactionRemoveListener;
;
